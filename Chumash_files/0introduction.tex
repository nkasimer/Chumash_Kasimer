...
\begin{minipage}[b][\textheight][b]{\textwidth}\englishfont	
	\begin{english}
		\vfill
		Copyright information here \clearpage
...
%\nocite{MAPM}
. The text was selected for its open licensing, extensive source documentation, and accuracy in presenting the masoretic text.  The text of Targum is the Wikisource Targum
%\nocite{targum}
, which is based on Yemenite texts (particularly the 1901 edition of the Taj). It was selected for its accurate vocalization.
...
%\nocite{1917JPS}
, and text of Rashi is from the Metzudah edition
%\nocite{metzudah_rashi}
3.  All these texts were retrieved from Sefaria. Data for aliya divisions, haftarot, and lengths of parshiyot was pulled from Hebcal. Information on which special \textit{Maftir} and \textit{Haftarot} can occur on which Sabbaths is from the Koren Shabbat Chumash
%\nocite{koren_shabbat}
.\\
