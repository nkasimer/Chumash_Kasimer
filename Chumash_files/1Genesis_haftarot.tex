...
\newhaftarah{בראשית}
\label{haft_1}
\haftnote{The Haftara is Isaiah 42:5\verserangechar 43:10. On Erev Rosh \d{H}odesh, some read the Haftara on page \pageref{haft_macharchodesh}, while some read the Parshaâ€™s Haftara even on Erev Rosh \d{H}odesh.}
\setcounter{chap}{42}
\setcounter{verse}{5}
...
\newhaftarah{וישב}
\label{haft_9}
\haftnote{The Haftara is Amos 2:6\verserangechar 3:8. On \d{H}anukka, read the Maftir on page \pageref{maft_hanukka}. See there for notes on which Maftir to read.  The Haftara is on page \pageref{haft_hanukka}.}
\setcounter{chap}{2}
\setcounter{verse}{6}
\twoverse{\Roman{chap}:\arabic{verse}}
