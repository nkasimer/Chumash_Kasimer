...
\newhaftarah{מטות}
\label{haft_42}
\haftnote{The Haftara is Jeremiah 1:1\verserangechar 2:3. This Haftara is always read the first Shabbat after the 17th of Tammuz.}
\setcounter{chap}{1}
\setcounter{verse}{1}
\twoverse{\Roman{chap}:\arabic{verse}}
...
\newhaftarah{מסעי}
\label{haft_43}
\haftnote{The Haftara is Jeremiah 2:4\verserangechar 2:28 \tworange 3:4\verserangechar 3:4. Read this Haftara even on Rosh \d{H}odesh.  The Rosh \d{H}odesh Maftir, Numbers 28:9\verserangechar 15 is still read, on page \pageref{maft_ShabRCh}.}
\setcounter{chap}{2}
\setcounter{verse}{4}
\twoverse{\Roman{chap}:\arabic{verse}}
